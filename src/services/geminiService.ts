...
لديك دليل التنسيق لكل سؤال — يُريك نوع العملية فقط (ضرب؟ قسمة؟ جمع؟) بدون أي أرقام.
استخدم دليل التنسيق لـ:
▸ معرفة نوع المعادلة
▸ تمييز الحروف العربية من الأرقام (ح، ع، م)
▸ معرفة عدد الخطوات التقريبي
لكن: كل الأرقام (□) تأتي من الصورة فقط — لا تحسب ولا تستنتج.
